...
with col1:
    ...
    st.subheader("📄 Form 16/ Form 22 Analysis")
    
    # Improved file uploader
    uploaded_file = st.file_uploader("Upload your Form 16/ Form 22 (PDF)", type=["pdf"])
    ...
    if uploaded_file:
        ...
        st.info("Upload your Form 16/ Form 22 PDF to automatically extract tax information and calculate your liability.")
    ...
    resources = {
        ...
        "Tax Calculator": "https://incometaxindia.gov.in/Pages/tools/tax-calculator.aspx?ID=442",
...
# Use the API key securely (Example: for an API request)
